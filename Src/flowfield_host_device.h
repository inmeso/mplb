...
enum VertexGeometryType {
    ...
    VG_IMJMKP_I = 1121300,
    VG_IMJMKM_I = 1121310,
    // planar surface intersection with boundary concave edge
    VG_IPJP_I_KP = 1020030,
    VG_IPJM_I_KP = 1021030,
    VG_IMJP_I_KP = 1120030,
    VG_IMJM_I_KP = 1121030,
    VG_IPJP_I_KM = 1020031,
    VG_IPJM_I_KM = 1021031,
    VG_IMJP_I_KM = 1120031,
    VG_IMJM_I_KM = 1121031,
    VG_IPKP_I_JP = 1030020,
    VG_IPKM_I_JP = 1031020,
    VG_IMKP_I_JP = 1130020,
    VG_IMKM_I_JP = 1131020,
    VG_IPKP_I_JM = 1030021,
    VG_IPKM_I_JM = 1031021,
    VG_IMKP_I_JM = 1130021,
    VG_IMKM_I_JM = 1131021,
    VG_JPKP_I_IP = 2030010,
    VG_JPKM_I_IP = 2031010,
    VG_JMKP_I_IP = 2130010,
    VG_JMKM_I_IP = 2131010,
    VG_JPKP_I_IM = 2030011,
    VG_JPKM_I_IM = 2031011,
    VG_JMKP_I_IM = 2130011,
    VG_JMKM_I_IM = 2131011,
    ...
    VG_IMJMKP_O = 1121301,
    VG_IMJMKM_O = 1121311,
    // planar surface intersection with boundary convex edge
    VG_IPJP_O_KP = 1020130,
    VG_IPJM_O_KP = 1021130,
    VG_IMJP_O_KP = 1120130,
    VG_IMJM_O_KP = 1121130,
    VG_IPJP_O_KM = 1020131,
    VG_IPJM_O_KM = 1021131,
    VG_IMJP_O_KM = 1120131,
    VG_IMJM_O_KM = 1121131,
    VG_IPKP_O_JP = 1030120,
    VG_IPKM_O_JP = 1031120,
    VG_IMKP_O_JP = 1130120,
    VG_IMKM_O_JP = 1131120,
    VG_IPKP_O_JM = 1030121,
    VG_IPKM_O_JM = 1031121,
    VG_IMKP_O_JM = 1130121,
    VG_IMKM_O_JM = 1131121,
    VG_JPKP_O_IP = 2030110,
    VG_JPKM_O_IP = 2031110,
    VG_JMKP_O_IP = 2130110,
    VG_JMKM_O_IP = 2131110,
    VG_JPKP_O_IM = 2030111,
    VG_JPKM_O_IM = 2031111,
    VG_JMKP_O_IM = 2130111,
    VG_JMKM_O_IM = 2131111,
